...
const socialLinks = [
  {
    name: "Spotify",
    href: "https://open.spotify.com/artist/4wvLrbEOvsCYp4LKrUxlBJ",
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/thisisperley/",
    icon: (props: React.SVGProps<SVGSVGElement>) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@thisisperley",
    icon: (props: React.SVGProps<SVGSVGElement>) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  {
    name: "Bandcamp",
    href: "https://perley.bandcamp.com/",
    icon: (props: React.SVGProps<SVGSVGElement>) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zM9.6 16.5H2.7l4.8-9h6.9l-4.8 9z"/>
      </svg>
    ),
  },
];
...
export const Footer = () => {
  ...
  return (
    <footer 
      className="relative min-h-[300px] text-white"
    >
      {/* Content */}
      <div className="container mx-auto px-4 py-16 relative">
        <div className="flex flex-col items-center">
          ...
          <div className="flex space-x-8 mb-8">
            {socialLinks.map((item) => (
              <TrackedLink
                ...
                eventData={{ platform: item.name.toLowerCase() }}
          ...
          <p className="text-sm text-white bg-[#232323] px-3 py-1">
            Website by{" "}
            <TrackedLink
              href="https://www.rocket5studios.com"
              eventName="external-link"
              eventData={{ destination: "rocket5studios" }}
