        ...
        {album.released ? (
          <>
            ...
            <div className="mt-2 flex flex-wrap gap-4">
              {album.links.spotify && (
                <StreamingIcon href={album.links.spotify} label="Listen on Spotify">
              ...
              {album.links.bandcamp && (
                <StreamingIcon href={album.links.bandcamp} label="Listen on Bandcamp">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {album.links.tidal && (
                <StreamingIcon href={album.links.tidal} label="Listen on Tidal">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {album.links.youtubemusic && (
                <StreamingIcon href={album.links.youtubemusic} label="Listen on YouTube Music">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {album.links.amazon && (
                <StreamingIcon href={album.links.amazon} label="Listen on Amazon Music">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {album.links.applemusic && (
                <StreamingIcon href={album.links.applemusic} label="Listen on Apple Music">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {album.links.iheartradio && (
                <StreamingIcon href={album.links.iheartradio} label="Listen on iHeartRadio">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
