...
const StreamingIcon = ({
  ...
  <button
    ...
    onClick={(e) => {
      e.preventDefault();
      e.stopPropagation();
      // Track the streaming click with Umami
      if (typeof window !== "undefined" && window.umami) {
        window.umami.track("streaming-click", {
          platform,
          album: albumTitle,
        });
      }
    ...
    <>
      ...
      <div className="flex flex-col justify-between flex-1">
        {album.released ? (
          <>
            <div>
              <h2 className="font-inter font-semibold text-2xl md:text-3xl tracking-tight text-white mb-1">
                Perley • {album.title}
              </h2>
            ...
            <div className="mt-2 flex flex-wrap gap-4">
              {album.links.spotify && (
                <StreamingIcon href={album.links.spotify} label="Listen on Spotify" platform="spotify" albumTitle={album.title}>
              ...
              {album.links.bandcamp && (
                <StreamingIcon href={album.links.bandcamp} label="Listen on Bandcamp" platform="bandcamp" albumTitle={album.title}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {album.links.tidal && (
                <StreamingIcon href={album.links.tidal} label="Listen on Tidal" platform="tidal" albumTitle={album.title}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {album.links.youtubemusic && (
                <StreamingIcon href={album.links.youtubemusic} label="Listen on YouTube Music" platform="youtube-music" albumTitle={album.title}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {album.links.amazon && (
                <StreamingIcon href={album.links.amazon} label="Listen on Amazon Music" platform="amazon-music" albumTitle={album.title}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {album.links.applemusic && (
                <StreamingIcon href={album.links.applemusic} label="Listen on Apple Music" platform="apple-music" albumTitle={album.title}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {album.links.iheartradio && (
                <StreamingIcon href={album.links.iheartradio} label="Listen on iHeartRadio" platform="iheartradio" albumTitle={album.title}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="flex flex-col h-full justify-center">
            <p className="font-inter font-semibold text-2xl md:text-3xl tracking-tight text-white">
              Coming Soon
            </p>
          </div>
        )}
